...
use App\Http\Requests\StoreKomponendRequest as StoreRequest;
use App\Http\Requests\UpdateKomponendRequest as UpdateRequest;

class KomponendCrudController extends CrudController {
    ...
    public function setUp() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel("App\Models\Komponend");
        $this->crud->setRoute("admin/pengamatan/komponen-d");
        $this->crud->setEntityNameStrings('Komponen D', 'Komponen D');
    ...
    {
        $komponend = $this->crud->getEntry($id);
        return view('vendor.backpack.crud.komponend_details_row', compact('komponend'));
    }
}
