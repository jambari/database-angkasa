...
use App\Http\Requests\StoreKomponenfRequest as StoreRequest;
use App\Http\Requests\UpdateKomponenfRequest as UpdateRequest;

class KomponenfCrudController extends CrudController {
    ...
    public function setUp() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel("App\Models\Komponenf");
        $this->crud->setRoute("admin/pengamatan/komponen-f");
        $this->crud->setEntityNameStrings('Komponen F', 'Komponen F');
    ...
    {
        $komponenf = $this->crud->getEntry($id);
        return view('vendor.backpack.crud.komponenf_details_row', compact('komponenf'));
    }
