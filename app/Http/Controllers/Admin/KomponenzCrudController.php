...
use App\Http\Requests\StoreKomponenzRequest as StoreRequest;
use App\Http\Requests\UpdateKomponenzRequest as UpdateRequest;

class KomponenzCrudController extends CrudController {
    ...
    public function setUp() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel("App\Models\Komponenz");
        $this->crud->setRoute("admin/pengamatan/komponen-z");
        $this->crud->setEntityNameStrings('Komponen Z', 'Komponen Z');
    ...
    {
        $komponenz = $this->crud->getEntry($id);
        return view('vendor.backpack.crud.komponenz_details_row', compact('komponenz'));
    }
