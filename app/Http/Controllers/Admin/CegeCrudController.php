...
use App\Http\Requests\StoreCegeRequest as StoreRequest;
use App\Http\Requests\UpdateCegeRequest as UpdateRequest;

class CegeCrudController extends CrudController {
    ...
    public function setUp() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel("App\Models\Cege");
        $this->crud->setRoute("admin/pengamatan/sambaran");
    ...
    {
        $cege = $this->crud->getEntry($id);
        return view('vendor.backpack.crud.cege_details_row', compact('cege'));
    }
}
