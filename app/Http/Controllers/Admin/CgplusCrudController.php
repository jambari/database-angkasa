...
use App\Http\Requests\StoreCgplusRequest as StoreRequest;
use App\Http\Requests\UpdateCgplusRequest as UpdateRequest;

class CgplusCrudController extends CrudController {
    ...
    public function setUp() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel("App\Models\Cgplus");
        $this->crud->setRoute("admin/pengamatan/cgplus");
    ...
    {
        $cgplus = $this->crud->getEntry($id);
        return view('vendor.backpack.crud.cgplus_details_row', compact('cgplus'));
    }
}
