...
use App\Http\Requests\StoreKomponeniRequest as StoreRequest;
use App\Http\Requests\UpdateKomponeniRequest as UpdateRequest;

class KomponeniCrudController extends CrudController {
    ...
    public function setUp() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel("App\Models\Komponeni");
        $this->crud->setRoute("admin/pengamatan/komponen-i");
        $this->crud->setEntityNameStrings('Komponen I', 'Komponen I');
    ...
    {
        $komponeni = $this->crud->getEntry($id);
        return view('vendor.backpack.crud.komponeni_details_row', compact('komponeni'));
    }
}
