...
use App\Http\Requests\StoreKomponenhRequest as StoreRequest;
use App\Http\Requests\UpdateKomponenhRequest as UpdateRequest;

class KomponenhCrudController extends CrudController {
    ...
    public function setUp() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel("App\Models\Komponenh");
        $this->crud->setRoute("admin/pengamatan/komponen-h");
        $this->crud->setEntityNameStrings('komponen H', 'Komponen H');
    ...
    {
        $komponenh = $this->crud->getEntry($id);
        return view('vendor.backpack.crud.komponenh_details_row', compact('komponenh'));
    }
}
