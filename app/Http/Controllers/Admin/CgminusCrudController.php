...
use App\Http\Requests\StoreCgminusRequest as StoreRequest;
use App\Http\Requests\UpdateCgminusRequest as UpdateRequest;

class CgminusCrudController extends CrudController {
    ...
    public function setUp() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel("App\Models\Cgminus");
        $this->crud->setRoute("admin/pengamatan/cgminus");
        $this->crud->setEntityNameStrings('CG-', 'CG-');
    ...
    {
        $cgminus = $this->crud->getEntry($id);
        return view('vendor.backpack.crud.cgminus_details_row', compact('cgminus'));
    }
}
