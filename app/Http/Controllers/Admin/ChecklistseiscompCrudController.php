...
use App\Http\Requests\StoreChecklistseiscompRequest as StoreRequest;
use App\Http\Requests\UpdateChecklistseiscompRequest as UpdateRequest;

class ChecklistseiscompCrudController extends CrudController
{
    ...
    public function setUp()
    {
		...
		|--------------------------------------------------------------------------
		*/
        $this->crud->setModel("App\Models\Checklistseiscomp");
        $this->crud->setRoute("admin/pengamatan/checklist-seiscomp3");
        $this->crud->setEntityNameStrings('checklist seiscomp', 'checklist seiscomps');
		...
		*/
        ...
        $this->crud->removeField('on', 'update/create/both');
        $this->crud->removeField('off', 'update/create/both');
        $this->crud->removeField('persentase', 'update/create/both');
        //$this->crud->removeField('petugas', 'update/create/both');
        ...
        //$this->crud->setColumnDetails('jam01', ['attribute' => 'value']); // adjusts the properties of the passed in column (by name)
